...
class LangvangeSelection extends StatefulWidget {
  const LangvangeSelection({super.key});

  @override
  State<LangvangeSelection> createState() => _LangvangeSelectionState();
}

class _LangvangeSelectionState extends State<LangvangeSelection> {
  bool marathi = false;
